...
Time_Start = pd.Timestamp('2015-10-8')
Time_End = pd.Timestamp('2015-11-1')

# Time_Start = pd.Timestamp('2013-7-25')
# Time_End = pd.Timestamp('2013-8-9')

# Time_Start = pd.Timestamp('2012-7-29')
# Time_End = pd.Timestamp('2012-8-13')
...
Range_H2O = np.linspace(10,30,20)
Range_TA = np.linspace(20,40,20)
Range_SWC = np.linspace(0.15,0.45,20)
Range_TS = np.linspace(24.5,29.5,20)
...
plt.xlim(Time_Start, Time_End)
plt.ylim(TA_Min,TA_Max)
#plt.title('Pit 2 (~30.5 m from K34 Tower)')

# Precipitation with CO2, Ts, and Ta
...
ax9 = fig1.add_subplot(gs[1,0])
im1 = plt.contourf(Time_Met, Height_CO2,CO2_Profile,levels = 20,cmap=cm.jet)
...
im2 = plt.contourf(Time_Met, Height_CO2,H2O_Profile,levels = 20,cmap=cm.jet_r)
plt.ylabel('K34 H2O height (m)')
bax = fig1.add_subplot(gs[2,1])
cbar = plt.colorbar(im2,bax)
#plt.colorbar()

fig1.add_subplot(gs[3,0],sharex = ax9)
im3 = plt.contourf(Time, Depth_Soil,Soil_Data,levels = 20,cmap=cm.jet_r)
plt.ylabel('K34 Soil Moisture Depth (cm)')
bax = fig1.add_subplot(gs[3,1])
...
#plt.subplot(3,1,2, sharex = ax9,sharey = ax9)
fig1.add_subplot(gs[2,0],sharex = ax9)
im2 = plt.contourf(Time, Depth_Tem,SoilT_Data,levels = Range_TS,cmap=cm.jet)
plt.ylabel('Ts Depth (cm)')
bax = fig1.add_subplot(gs[2,1])
cbar = plt.colorbar(im2,bax)

fig1.add_subplot(gs[3,0],sharex = ax9)
im3 = plt.contourf(Time, Depth_Soil,Soil_Data,levels = Range_SWC,cmap=cm.jet_r)
plt.ylabel('SWC Depth (cm)')
bax = fig1.add_subplot(gs[3,1])
cbar = plt.colorbar(im3,bax)
