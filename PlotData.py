...
Time_End = pd.Timestamp('2016-07-01')

# variable range
Range_SWC = np.linspace(0.15,0.6,20)
...
#%%
# in a certain time range
Time_Start = pd.Timestamp('2015-09-08')
Time_End = pd.Timestamp('2015-10-15')
...
#contour range
Range_CO2 = np.linspace(300,500,20)
Range_H2O = np.linspace(5,25,20)
Range_TA = np.linspace(20,40,20)
Range_SWC = np.linspace(0.15,0.45,15)
Range_TS = np.linspace(24.5,29.5,15)
